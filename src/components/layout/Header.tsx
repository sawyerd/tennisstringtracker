    ...
    <>
      <header className="sticky top-0 z-30 bg-canvas/90 backdrop-blur border-b border-black/[0.06]">
        <div className="max-w-lg mx-auto px-4 h-14 flex items-center gap-3">
          ...
          {/* Avatar button — 44×44 touch target */}
          <button
      ...
      {/* Dropdown menu — rendered outside header so it can't be clipped */}
      {menuOpen && (
        <>
          {/* Backdrop */}
          <div
          ...
          />
          {/* Menu */}
          <div className="fixed top-14 right-4 z-50 w-48 bg-white rounded-[14px] shadow-card-hover border border-black/[0.06] py-1 max-w-[calc(100vw-2rem)]">
            ...
            <button
              ...
              className="w-full text-left px-3 py-2.5 text-sm text-red-600 hover:bg-red-50 active:bg-red-100 transition-colors rounded-b-[14px]"
            >
              Sign out
            </button>
          </div>
